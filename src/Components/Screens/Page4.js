...
export default class Page4 extends Component {
  ...
  async componentDidMount() {
    ...
    axios
      .get("http://qa.mag.gob.sv/PRA/api/pantallas/get-alertas-tempranas")
      .then((res) => {
  ...
  render() {
    ...
    return (
      <>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Typography variant="h4">
              Mantenimiento de Alertas Tempranas
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Button
        ...
        <Dialog
          open={this.state.Agregar_window}
          onClose={() => this.setState({ Agregar_window: false })}
          fullScreen
        >
          <DialogTitle>
            <Grid container spacing={2}>
              ...
              <Grid item xs={1}>
                <IconButton
                  ...
                  color="secondary"
                  size="small"
                  onClick={() => this.setState({ Agregar_window: false })}
                >
                  <CancelOutlined />
                </IconButton>
              </Grid>

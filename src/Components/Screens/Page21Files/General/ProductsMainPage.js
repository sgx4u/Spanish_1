...
export default class ProductsMainPage extends Component {
	...
	loadDefaultData = async () => {
		...
		let [Data, Data1] = await Promise.all([axios.get("https://siam-mag-dev.azurewebsites.net/api/pantallas/get-productores-lista"), axios.get("https://siam-mag-dev.azurewebsites.net/api/pantallas/categoris_lista")]);
		Data = Data.data;
		Data1 = Data1.data;

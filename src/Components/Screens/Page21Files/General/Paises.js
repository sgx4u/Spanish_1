...
export default class Paises extends Component {
  ...
  loadDefaultData = async () => {
    ...
    await axios
      .get(
        "https://siam-mag-dev.azurewebsites.net/api/pantallas/get-productores-exportaderos"
      )
      .then((res) => {
  ...
  LoadListData = async (value) => {
    ...
    let [Data, Data1] = await Promise.all([
      axios.get(
        "https://siam-mag-dev.azurewebsites.net/api/pantallas/get-paise-no-asociados/" +
          value
      ),
      // axios.get("https://siam-mag-dev.azurewebsites.net/api/pantallas/get-detalle-no-asociados/"+value)
      axios.get(
        "https://siam-mag-dev.azurewebsites.net/api/pantallas/get-paise-asociados/" +
          value
      ),
    ]);
    Data = Data.data;
  ...
  SaveData = async () => {
    ...
    await axios
      .post(
        "https://siam-mag-dev.azurewebsites.net/api/pantallas/get-productores-paises-ingresar",
        reqData,
        config
      )
      .then((res) => {
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={(e) => this.LoadListData(e.target.value)}
                >
                ...
                >
                  ...
                  >
                    {this.state.RightList.map((data, Index) => {
                      const labelId = `transfer-list-item-${
                        data.pais + Index
                      }-label`;
                      return (
                        <>

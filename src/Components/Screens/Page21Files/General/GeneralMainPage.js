...
export default class GeneralMainPage extends Component {
  ...
  loadDefaultData = async () => {
    ...
    await axios
      .get(
        "https://siam-mag-dev.azurewebsites.net/api/desarrollos/Get_Productores"
      )
      .then((res) => {
  ...
  render() {
    ...
    return (
      <>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={3}>
                <Button
                  ...
                  variant="outlined"
                  onClick={() =>
                    this.setState({ AddNew: true, Add_Edit_window: true })
                  }
                >
                  Crear Productor
                </Button>
        ...
        >
          <DialogTitle>
            {this.state.AddNew ? "Agregar Productor" : "Editar Productor"}
          </DialogTitle>
          <Divider />
          <DialogContent>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <center>
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={this.state.ModifiedData.exportador}
                        onChange={(e) =>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      variant="outlined"
                      fullWidth
                      value={this.state.ModifiedData.telephono}
                      onChange={(e) =>
                        this.TextFeildValueChanges(e.target.value, "telephono")
                      }
                    />
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      variant="outlined"
                      fullWidth
                      value={this.state.ModifiedData.direccion}
                      onChange={(e) =>
                        this.TextFeildValueChanges(e.target.value, "direccion")
                      }
                    />
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      variant="outlined"
                      fullWidth
                      value={this.state.ModifiedData.whatsapp}
                      onChange={(e) =>
                        this.TextFeildValueChanges(e.target.value, "whatsapp")
                      }
                    />
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      variant="outlined"
                      fullWidth
                      value={this.state.ModifiedData.instagram}
                      onChange={(e) =>
                        this.TextFeildValueChanges(e.target.value, "instagram")
                      }
                    />
                  </Grid>
                </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      ...
                      type="file"
                      onChange={(e) =>
                        this.onChangeFiles("file", "logo", e.target.files)
                      }
                    />
                  </Grid>
                </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={7}>
                      <TextField
                        variant="outlined"
                        fullWidth
                        value={this.state.ModifiedData.Estado}
                        select
                      >
          ...
          <DialogActions>
            <Button
              variant="outlined"
              color="secondary"
              onClick={() => this.CancelEditAddWindow()}
            >
              Cancelar
            </Button>
            <Button
              variant="outlined"
              onClick={() => this.Add_and_UpdateData()}
            >

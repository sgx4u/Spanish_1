...
export default class Page15 extends Component {
  ...
  loadDefaultData = async () => {
    ...
    //     console.log(error);
    // });
    let [DefaultData, FilterData] = await Promise.all([
      axios.get("http://qa.mag.gob.sv/PRA/api/pantallas/get-Sugerencias/1"),
      axios.get(
        "http://qa.mag.gob.sv/PRA/api/pantallas/get-filtro-Sugerencias"
      ),
    ]);
          ...
          <Grid item xs={6}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                fullWidth
                onChange={(e) => this.DropdownloadData(e.target.value)}
              >

...
export default class Page15 extends Component {
	constructor(props) {
		...
		this.state = {
			...
			Data: [
				{ Correo_Electrónico: "carlos.ponce@gmail.com", Comentario: "comentario 1", ID_Usuario: 23 },
				{ Correo_Electrónico: "pepe.ponce@gmail.com", Comentario: "comentario 2", ID_Usuario: 28 },
				{ Correo_Electrónico: "carlos.peñate@gmail.com", Comentario: "comentario 3", ID_Usuario: 3 },
				{ Correo_Electrónico: "dodo.caramelo19@gmail.com", Comentario: "comentario 4", ID_Usuario: 2 },
			],
			FilterData: [],

...
export default class Page23 extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Data: [
        {
          Nombre_Productor: "Juan Antonio Perez Gomez",
          Telefono: "70707070",
          Dirección: "ciudad merliot",
          WhatsApp: "70707070",
          Facebook: "juan.perez",
        ...
        {
          Nombre_Productor: "Juan Carlos Gomez Gome",
          Telefono: "70707070",
          Dirección: "ciudad merliot",
          WhatsApp: "70707070",
          Facebook: "juan.perez",
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Typography variant="h4">
              Mantenimiento de Certifcaciones de Productores
            </Typography>
          </Grid>
          <Grid item xs={12}>

        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <FormControl>
              ...
              >
                <FormControlLabel
                  value="Afecta a todo el País"
                  control={<Radio />}
                  label="Afecta a todo el País"
                />
                <FormControlLabel
                  value="Afecta a Departamento"
                  control={<Radio />}
                  label="Afecta a Departamento"
                />
                <FormControlLabel
                  value="Afecta a Municipio"
                  control={<Radio />}
                  label="Afecta a Municipio"
                />
              </RadioGroup>
            </FormControl>
          </Grid>

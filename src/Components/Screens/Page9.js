...
export default class Page9 extends Component {
  ...
  loadDefaultData = async () => {
    ...
    await axios
      .get("http://qa.mag.gob.sv/PRA/api/pantallas/get-tipos-de-informacion")
      .then((res) => {
  ...
  Edit_or_NewData = async () => {
    ...
    if (data.nombre === "") {
      ...
      if (data.AddNew) {
        await axios
          .post(
            "http://qa.mag.gob.sv/PRA/api/pantallas/add-tipos-de-Informacion/" +
              data.nombre +
              "/" +
        ...
        console.log(
          "http://qa.mag.gob.sv/PRA/api/pantallas/update-tipos-de-Informacion/" +
            data.id +
            "/" +
            data.nombre +
            "/" +
            data.activo +
            "/" +
            (data.SelectedFileName === null ? "" : data.SelectedFileName)
        );
        await axios
          .put(
            "http://qa.mag.gob.sv/PRA/api/pantallas/update-tipos-de-Informacion/" +
    ...
    return (
      <>
                      ...
                      <TableRow>
                        ...
                        <TableCell align="center">
                          <Button
                            ...
                            variant="outlined"
                            color="primary"
                            onClick={() => this.SelectedForEdit(data)}
                          >
                            Editar
                          </Button>
                        </TableCell>
        ...
        >
          <DialogTitle>
            {this.state.AddNew
              ? "Agregar Tipo de Información"
              : "Editar Tipo de Información"}
          </DialogTitle>
          <Divider />
          <DialogContent>
            <Grid container spacing={2}>

...
export default class Page5 extends Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			Data: [
				{ idAlertasTempranas: 1, idTipoAlerta: 1, textoAlerta: "Testing Data", descript: "Esta es una alerta de prueba", departamento: "San Vicente", municipio: "Apastepeque", active: "Activo", fechaCreado: "" },
				{ name: "Alerta 2", tipoalerta: "", description: "Esta es una alerta de prueba", departamento: "San Salvador", municipio: "Apopa", active: "Activo" },
				{ name: "Alerta 3", tipoalerta: "", description: "Esta es una alerta de prueba", departamento: "La Libertad", municipio: "Ciuad Arce", active: "Inactivo" },
				{ name: "Alerta 4", tipoalerta: "", description: "Esta es una alerta de prueba", departamento: "La Libertad", municipio: "Santa Tecla", active: "Activo" },
			],
			DropDowns: [],
		};
	}

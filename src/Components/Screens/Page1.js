...
export default class Page1 extends Component {
  ...
  loadDefaultData = async () => {
    ...
    axios
      .get(
        "https://siam-mag-dev.azurewebsites.net/api/pantallas/get-tipos-de-alertas"
      )
      .then((res) => {
  ...
  Add_and_UpdateData = async () => {
    ...
    if (this.state.AddNew) {
      await axios
        .post(
          "https://siam-mag-dev.azurewebsites.net/api/pantallas/add-tipo_alertas/" +
      ...
      await axios
        .put(
          "https://siam-mag-dev.azurewebsites.net/api/pantallas/update-tipos-de-Alertas/" +
            data.idTipoAlerta +
            "/" +
            data.nombreTipoAlerta +
            "/" +
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Typography variant="h4">
              Mantenimiento de Tipos de Información
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Button
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={7}>
                    <TextField
                      variant="outlined"
                      fullWidth
                      value={this.state.ModifiedData.nombreTipoAlerta}
                      onChange={(e) =>
                        this.TextFeildValueChanges(e.target.value)
                      }
                    />
                  </Grid>
                </Grid>

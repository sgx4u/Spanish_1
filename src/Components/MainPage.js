      ...
      <Scrollbar style={{ width: 250 }}>
        <List style={{ width: 250 }}>
          <ListItem
            style={{
              backgroundColor:
                selectedMenu === "Tipos_de_Alerta" ? "#d7efd2" : "",
            }}
            button
            key="Tipos_de_Alerta"
          ...
          <ListItem
            style={{
              backgroundColor:
                selectedMenu === "Alertas_Tempranas" ? "#d7efd2" : "",
            }}
            button
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                selectedMenu === "Tipos_de_Información" ? "#d7efd2" : "",
            }}
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                selectedMenu === "Detalle_de_Información" ? "#d7efd2" : "",
            }}
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                selectedMenu === "Certificaciones" ? "#d7efd2" : "",
            }}
            key="Certificaciones"
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                selectedMenu === "PreciosInternacionales" ? "#d7efd2" : "",
            }}
          ...
          <ListItem
            ...
            style={{
              backgroundColor:
                selectedMenu === "InformesdePrecios" ? "#d7efd2" : "",
            }}
